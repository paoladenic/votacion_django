...
def create_question(question_text, days): 
    ...
    return Question.objects.create(question_text=question_text, pub_dat=time)
...
class QuestionDetailViewTests(TestCase): 
    def test_future_question(self): 
        ...
        response = self.client.get(url) #peticion http
